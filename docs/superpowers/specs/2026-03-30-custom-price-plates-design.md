...
点击"总计"或"返回"按钮
  ↓
主模块触发 'view:changed' 事件
  ↓
CustomPlateEvents.onViewChange(view)
  ↓
如果是正视图 → 在右侧空白区域渲染P1/P2/P3
如果是俯视图 → 在指定位置渲染P1/P2/P3
```
